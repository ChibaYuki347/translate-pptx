...
def main() -> int:
    ...
    # Strings/patterns matching the allowlist are suppressed.
    ...
    if allowlist_path and (allow_literals or allow_patterns):
        print(
    ...
    if residual:
        print(
            ...
            "the translation dictionary, the allowlist, or accept as intentional:",
            file=sys.stderr,
        )
